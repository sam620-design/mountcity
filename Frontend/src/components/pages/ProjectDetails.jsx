...
<br><br>
  Each of our plots is designed to cater to various lifestyles and budgets, allowing you the flexibility to create a living space that reflects your unique vision. Whether you’re looking for a serene retreat on the outskirts of the city or a vibrant space close to urban conveniences, Mount City Developers has the perfect option for you. Our commitment to transparency ensures that you have all the information you need to make an informed decision. With a focus on customer satisfaction, we provide personalized support throughout the purchasing process. Discover the potential of our plots and start your journey toward building the home you’ve always dreamed of with Mount City Developers Pvt. Ltd.—where your vision meets reality...
    ...
    propertyDetails: [
      ...
      { type: "35'x30'", area: "1050 SQ.FT", count: 5 },
      { type: "30'x40'", area: "1200 SQ.FT", count: 68 },
      { type: "40'x40'", area: "1600 SQ.FT", count: 8 },
      { type: "50'x40'", area: "2000 SQ.FT", count: 7 },
      { type: "60'x40'", area: "2400 SQ.FT", count: 6 }
    ],
  },
  {
    id: 2,
...
And many more Government project coming to Rajgir....
    ...
    <div class=" flex  flex-wrap ">
      ...
      <div class="w-full ">
        ...
        <h3 class="text-base text-gray-600 italic mt-2">A Perfect Blend of Nature and Urban Living</h3>
        <p class="mt-4 text-base text-gray-600">
At Hi-Tech city, we specialize in providing prime residential plots that empower you to build your dream home. Our meticulously selected plots are situated in Rajgir , offering easy access to essential Amenities - Schools, Parks, Hospitals and Transportation. We understand that the right plot is the foundation of a perfect home, which is why we focus on quality land that meets the highest standards.
<br><br>
  Each of our plots is designed to cater to various lifestyles and budgets, allowing you the flexibility to create a living space that reflects your unique vision. Whether you’re looking for a serene retreat on the outskirts of the city or a vibrant space close to urban conveniences, Mount City Developers has the perfect option for you. Our commitment to transparency ensures that you have all the information you need to make an informed decision. With a focus on customer satisfaction, we provide personalized support throughout the purchasing process. Discover the potential of our plots and start your journey toward building the home you’ve always dreamed of with Mount City Developers Pvt. Ltd.—where your vision meets reality...
        </p>
        <div class="flex  items-center py-8">
          <div class="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-10 md:gap-40  text-primary">
            ...
            <!-- Acres -->
            <div>
              <h2 class="md:text-4xl text-3xl  font-semibold">10</h2>
              <p class="text-md text-gray-600">Acres</p>
            </div>
      
            <!-- Plots -->
            <div>
              <h2 class="md:text-4xl text-3xl font-semibold">145</h2>
              <p class="text-md text-gray-600">Plots</p>
            </div>
      
            <!-- Plot Range -->
            <div>
              <h2 class="md:text-4xl text-3xl font-semibold">875-2400</h2>
              <p class="text-md text-gray-600">SQFT(Plots Range)</p>
            </div>
    ...
    neighbours: [
      { name: 'Police Training Center', distance: '9 KM' },
      { name: 'CRPF Camp Rajgir', distance: '11 KM' },
      { name: 'K.K. University Phase - 2', distance: '17 KM' },
      { name: 'Ordnance Factory', distance: '0 KM' },
      { name: 'IT City', distance: '8 KM' },
      { name: 'Rajgir Film City', distance: '10 KM' },
      { name: 'Rajgir Bus Stand', distance: '3 KM' },
      { name: 'Jethian Hill', distance: '15 KM' },
      { name: 'Rajgir Railway Station', distance: '2.5 KM' },
      { name: 'International Cricket Stadium', distance: '8 KM' },
      { name: 'Sports Academy', distance: '8 KM' },
      { name: 'Venu Van', distance: '3.5 KM' },
      { name: 'Brahma Kund', distance: '4 KM' },
      { name: 'Rajgir Ropeway & Shanti Stupa', distance: '7 KM' },
      { name: 'Ghora Katora', distance: '7 KM' },
      { name: 'Sone Bhandar', distance: '5 KM' }
    ],
...
And many more Government project coming to Rajgir....
    ...
    <div class=" flex  flex-wrap ">
      ...
      <div class="w-full ">
        ...
        <h3 class="text-base text-gray-600 italic mt-2">A Perfect Blend of Nature and Urban Living</h3>
        <p class="mt-4 text-base text-gray-600">
At Nutan Vatika, we specialize in providing prime residential plots that empower you to build your dream home. Our meticulously selected plots are situated in Rajgir , offering easy access to essential Amenities - Schools, Parks, Hospitals and Transportation. We understand that the right plot is the foundation of a perfect home, which is why we focus on quality land that meets the highest standards.
<br><br>
  Each of our plots is designed to cater to various lifestyles and budgets, allowing you the flexibility to create a living space that reflects your unique vision. Whether you’re looking for a serene retreat on the outskirts of the city or a vibrant space close to urban conveniences, Mount City Developers has the perfect option for you. Our commitment to transparency ensures that you have all the information you need to make an informed decision. With a focus on customer satisfaction, we provide personalized support throughout the purchasing process. Discover the potential of our plots and start your journey toward building the home you’ve always dreamed of with Mount City Developers Pvt. Ltd.—where your vision meets reality...
        </p>
        <div class="flex  items-center py-8">
          <div class="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-10 md:gap-40  text-primary">
            ...
            <!-- Acres -->
            <div>
              <h2 class="md:text-4xl text-3xl  font-semibold">25</h2>
              <p class="text-md text-gray-600">Acres</p>
            </div>
      
            <!-- Plots -->
            <div>
              <h2 class="md:text-4xl text-3xl font-semibold">392</h2>
              <p class="text-md text-gray-600">Plots</p>
            </div>
      
            <!-- Plot Range -->
            <div>
              <h2 class="md:text-4xl text-3xl font-semibold">600-1800</h2>
              <p class="text-md text-gray-600">SQFT(Plots Range)</p>
            </div>
    ...
    propertyDetails: [
      ...
      { type: "45'x35'", area: "1575 SQ.FT", count: 20 },
      { type: "30'x50'", area: "1500 SQ.FT", count: 1 },
      { type: "30'x45'", area: "1350 SQ.FT", count: 38 },
      { type: "30'x40'", area: "1200 SQ.FT", count: 66 },
      { type: "25'x45'", area: "1125 SQ.FT", count: 9 },
      { type: "30'x35'", area: "1050 SQ.FT", count: 24 },
      { type: "40'x25'", area: "1000 SQ.FT", count: 25 },
      { type: "30'x30'", area: "900 SQ.FT", count: 50 },
      { type: "30'x25'", area: "750 SQ.FT", count: 18 },
      { type: "30'x20'", area: "600 SQ.FT", count: 84 },
    ],
  }
]
...
function ProjectDetails() {
  ...
  const { id } = useParams();
  let project = projectdetails.find((p) => p.id === parseInt(id));
  ...
  return (
    ...
    <div className="  pt-4 ">
      ...
      <div className='max-w-7xl  container mx-auto'>
        ...
        />
        <Link to={`/plot/${project.id}`} className='bg-green-500 p-3 ml-4 rounded-md shadow-lg   transition-all duration-500 text-white hover:bg-green-600'>
          View Plot
        </Link>
          ...
          <table className="w-full mt-8  text-center bg-white shadow-lg rounded-lg">
            <thead className="bg-primary text-white">
              <tr>
                ...
                {project.propertyDetails[0].count !== undefined && <th className="px-6 py-4">No. of Plots</th>}
              </tr>
            </thead>
            <tbody>
              {project.propertyDetails.map((item, index) => (
                <tr key={index} className={index % 2 !== 0 ? "bg-yellow-50 " : ""}>
                  <td className="border-t px-6 py-4">{item.type}</td>
                  <td className="border-t px-6 py-4">{item.area}</td>
                  {item.count !== undefined && <td className="border-t px-6 py-4">{item.count}</td>}
                </tr>
              ))}
            </tbody>
          </table>
